...
public class SearchRooms extends AppCompatActivity {
    String Search, Browse, Space, Cap, Rat, searchQuery, ip, db, un, pass, Pr, updateQuery, passedH;
    ...
    public void onButtonClickSearchRating(View v){
        ...
        Rat = "Rating: ";
        Pr = "| Price: ";
        searchQuery = "SELECT * FROM DB_A2EB9D_471Hotels.dbo.Rooms WHERE H_Name = '"+passedH+"' AND Rating = '"+ratingString+"' AND Availability = 'Yes'";
            ...
            while(reset.next())
            {
               ...
               btn.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View v) {
                        ...
                        Intent goHome = new Intent(SearchRooms.this, MainActivity.class);
    ...
    public void onButtonClickSearchPrice(View v){
        ...
        Rat = "Rating: ";
        Pr = "| Price: ";
        searchQuery = "SELECT * FROM DB_A2EB9D_471Hotels.dbo.Rooms WHERE H_Name = '"+passedH+"' AND Price = '"+priceString+"' AND Availability = 'Yes';";
        final LinearLayout lm = (LinearLayout) findViewById(R.id.scrollRooms);
        if(searchedBefore == 1) {
            lm.removeAllViews();
        }
